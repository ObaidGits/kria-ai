...
use crate::stores::sqlite_vectors::{PartitionId, SqliteVectorStore, VectorPayloadV2};
...
mod tests {
    use super::*;
    use crate::db::Database;
    use crate::stores::manifest::EmbeddingPartitionManifest;
    use crate::stores::sqlite_vectors::ensure_partition;
    use std::sync::Arc;
