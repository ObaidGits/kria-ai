...
//! backend ([`crate::runtime_backend::KriaMemoryRuntime`]), the
...
///
/// **Superseded by** [`crate::model::Record`] (`RecordKind::Memory`) —
/// the decay/access bookkeeping becomes retrieval-time scoring rather than
/// stored columns. Retained as the live
/// [`crate::runtime_backend::KriaMemoryRuntime`] fact read/write model
