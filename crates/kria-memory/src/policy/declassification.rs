...
//! completion [`event`](crate::authority::event_log) and an immutable
//! [`audit_record`](crate::authority::audit), and is **reversible** via
...
use crate::model::{AuditId, DeclassificationId, UtcTimestamp};
...
pub fn declassification_command(
    caller: crate::model::CallerContext,
    idempotency_key: crate::model::IdempotencyKey,
    base_revision: crate::model::GraphRevision,
    source: crate::authority::SourceContext,
    mode: crate::types::MemoryMode,
    deadline: crate::authority::Deadline,
    preview_token: crate::authority::PreviewToken,
    declassification: &Declassification,
...
mod tests {
    use super::*;
    use crate::authority::{SourceContext, SourceKind, SourceTrust};
    ...
    fn declassify_envelope(d: &Declassification) -> CommandEnvelope {
        declassification_command(
            ...
            crate::authority::Deadline::default_write(),
            crate::authority::PreviewToken::new("tok-declassify").unwrap(),
            d,
        )
        .unwrap()
    }
