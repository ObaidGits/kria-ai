...
//!
//! This mirrors [`EffectivePolicy::provenance_hash`](crate::policy::effective_policy::EffectivePolicy::provenance_hash)
//! and [`CommandHash::compute`](crate::authority::command::CommandHash):
...
/// [`crate::authority::command::CommandHash`]'s schema tag).
...
mod tests {
    use super::*;
    use crate::model::relation_registry::{EvidencePolicy, RelationName, ValidityPolicy};
    use crate::model::{UtcTimestamp, Version};
