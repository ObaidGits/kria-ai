...
//! is [`crate::model::legacy_mapping`], task 2.1.6):
//!
...
mod tests {
    ...
    fn evidence_provenance_captures_parents_and_actor() {
        use crate::model::entity::{Evidence, EvidencePolarity};
        use crate::model::EvidenceId;
    ...
    fn consolidation_and_retrieval_trace_carry_model_identity() {
        use crate::model::consolidation::{ConsolidationLevel, ConsolidationRun};
        use crate::model::observation::RetrievalTrace;
        use crate::model::{ConsolidationRunId, RetrievalTraceId};
