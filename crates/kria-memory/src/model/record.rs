...
//!     [`crate::ids::normalized_content_hash`]). Identical content →
...
//!     `~4 chars/token` heuristic ([`crate::governance::estimate_tokens`]),
...
use crate::governance::estimate_tokens as estimate_tokens_heuristic;
use crate::ids::normalized_content_hash;
...
impl Record {
    ...
    /// ([`crate::governance::estimate_tokens`]). Reused verbatim so v2
