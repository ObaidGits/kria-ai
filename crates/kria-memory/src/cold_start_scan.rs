...
//! ([`MemorySystem::cold_start_import`](crate::api::MemorySystem::cold_start_import))
...
use crate::cold_start::{ColdStartConsent, ScanCandidate, ScanSource};
...
/// cannot slip in. Reuses the deterministic [`sensitivity`](crate::sensitivity)
...
pub fn content_has_secret(text: &str) -> bool {
    if crate::sensitivity::classify(text).class == crate::types::Sensitivity::Secret
    {
        return true;
    }
...
mod tests {
    use super::*;
    use crate::cold_start::ColdStartConsent;
