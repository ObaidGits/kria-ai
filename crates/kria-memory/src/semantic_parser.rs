...
pub struct SemanticMemoryParser {
    parser_client: Arc<dyn SemanticExtractionLlm>,
    max_tokens: u32,
}

impl SemanticMemoryParser {
    pub fn new(parser_client: Arc<dyn SemanticExtractionLlm>) -> Self {
        Self {
            parser_client,
            max_tokens: 512,
        }
    ...
    pub async fn parse_turn(
        ...
        // One narrow call through the inverted seam: the crate asks for text and
