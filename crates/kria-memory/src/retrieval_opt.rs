...
//!
//! Learns per-[`QueryClass`](crate::retriever::QueryClass) RRF fusion
...
//! (bounded, evidence-gated). The [`Retriever`](crate::retriever::Retriever)
...
use crate::retriever::QueryClass;
