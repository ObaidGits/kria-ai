...
string_enum! {
    ...
    /// canonical mode gate ([`crate::modes`], task F1.4.4).
    ///
    ...
    /// [`MemoryMode::class`](crate::modes::ModeClass); the extra
...
///
/// **Superseded by** the structured [`crate::model::Provenance`] +
/// [`crate::model::SourceRef`] (canonical v2 provenance). Retained as
/// the live write-path provenance tag until the F1.5 write cutover; see the
/// ledger in [`crate::model::legacy_mapping`] (task F2.1.6).
#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub enum Source {
...
///
/// **Superseded by** [`crate::model::Record`]
/// (`RecordKind::Memory`) + [`crate::model::Provenance`] (canonical v2
...
///
/// **Superseded by** [`crate::model::Entity`] (`entities_v2`) +
/// [`crate::model::Alias`]/[`crate::model::Mention`] (canonical
...
//   - F3.3 traversal result over `crate::model::Entity` (v2)
// See `crate::model::legacy_mapping` for the cutover ledger.
