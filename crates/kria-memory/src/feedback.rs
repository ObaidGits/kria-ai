...
//! crate::authority::CommandCandidate::feedback_signal) is the typed
...
//! row. See the ledger in [`crate::model::legacy_mapping`].
...
impl FeedbackSignal {
    ...
    /// mutation routed through [`crate::api::MemorySystem::correct`],
