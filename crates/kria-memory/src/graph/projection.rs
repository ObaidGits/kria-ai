...
use crate::model::{EntityId, GraphRevision, RecordId, TruthState, UtcTimestamp};
...
/// (see [`crate::policy::effective_policy::EffectivePolicy`]).
///
...
pub struct EffectivePolicySummary {
    ...
    /// [`crate::policy::effective_policy::EffectivePolicy::provenance_hash`]).
...
///
/// The full [`crate::model::Provenance`] is available to authorized
...
/// caller's [`CallerContext`](crate::model::CallerContext).  The
...
mod tests {
    use super::*;
    use crate::model::{EntityId, GraphRevision, RecordId, UtcTimestamp};
    use crate::types::StalenessClass;
