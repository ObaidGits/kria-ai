...
use crate::stores::ports::{Embedder, RelationalStore, SearchStore, VectorStore};
use crate::types::{Availability, Memory, MemoryState, Scope, ScopeFilter};
...
pub struct Retriever {
    ...
    weights: Option<crate::retrieval_opt::RetrievalWeightStore>,
}
...
impl Retriever {
    ...
    pub fn with_weight_store(
        mut self,
        weights: crate::retrieval_opt::RetrievalWeightStore,
    ) -> Self {
...
mod tests {
    ...
    use crate::stores::ports::{Embedder, EventStore};
    use crate::stores::{SqliteEventStore, SqliteRelationalStore, SqliteVectorStore};
    use crate::types::{EmphasisSignals, Event, EventType, ModelVersion, Source};
    ...
    fn retriever(db: &Arc<Database>) -> Retriever {
        Retriever::new(
            ...
            Arc::new(crate::stores::SqliteSearchStore::new(db.clone())),
