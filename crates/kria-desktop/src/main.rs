...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::memory::memory_v2_dispatch,
            commands::memory::memory_seed_demo_knowledge,
            commands::memory::memory_knowledge_items,
            ...
            commands::feature_controls::list_feature_controls,
            commands::feature_controls::set_feature_enabled,
