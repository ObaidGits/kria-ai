...
pub fn build_default_mount_manager() -> ToolMountManager {
    ...
    mm.define_group(
        ...
        vec![
            ...
            "gw_calendar_availability".into(),
            "gw_morning_briefing".into(),
            "gw_gmail_draft_create".into(),
            "gw_account_switch".into(),
    ...
    mm.define_group(
        ...
        vec![
            ...
            "gw_gmail_draft_create".into(),
            "gw_gmail_send_draft".into(),
            "gw_gmail_send_bulk".into(),
            "gw_drive_delete".into(),
            "gw_calendar_create".into(),
            "gw_calendar_update".into(),
