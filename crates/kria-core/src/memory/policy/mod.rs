...
//! from the legacy [`crate::memory::write_policy`] module (the v1 write gate),
...
//! ([`crate::memory::authority::command`]'s
//! [`SourceKind`](crate::memory::authority::SourceKind) /
//! [`SourceTrust`](crate::memory::authority::SourceTrust) /
//! [`SourceContext`](crate::memory::authority::SourceContext)) and the caller
//! model ([`crate::memory::model::CallerOrigin`]).
//!
//! ## Module map (F1.4)
//!
...
//! * [`crate::memory::modes`] — **F1.4.4**: the five canonical `Memory_Mode`
