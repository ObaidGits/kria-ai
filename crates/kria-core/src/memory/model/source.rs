...
//! the existing **closed** [`crate::memory::authority::command::SourceKind`]
...
//! legacy provenance [`crate::memory::types::Source`], whose canonical
//! replacement (structured [`crate::memory::model::Provenance`] +
//! [`crate::memory::model::SourceRef`]) and cutover gate are recorded in
