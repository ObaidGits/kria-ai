...
//!          [`string_enum!`](crate::memory::types) `Other(String)` fallback; and
...
//!         with [`StorageError::Encoding`](crate::memory::error::StorageError)
//!         (see [`RecordKind`](crate::memory::model::RecordKind) et al.); and
