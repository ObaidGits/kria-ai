...
use crate::memory::retrieval::rrf_fusion::{StrategyAvailability, StrategyInput, StrategyKind};
use crate::memory::retrieval::rrf_profile::FusionProfile;
...
mod tests {
    ...
    use crate::memory::retrieval::rrf_fusion::StrategyAvailability;
    use crate::memory::retrieval::rrf_profile::PROFILE_EXPLORATORY;
