...
///
/// ```rust
/// use kria_core::memory::api::v2::adapters::{AdapterKind, AdapterLimits};
///
...
///
/// ```rust
/// use kria_core::memory::api::v2::adapters::{AdapterKind, validate_adapter_request};
/// use kria_core::memory::api::v2::dto::GraphRequestV2;
/// use kria_core::memory::api::v2::error::MemoryApiErrorV2;
/// use serde_json::json;
///
