...
use crate::memory::types::{Memory, MemoryState, MemoryWorth};
...
impl MergeService {
    ...
    pub fn merge(&self, a: Uuid, b: Uuid) -> MemoryResult<Uuid> {
        ...
        let merged = Memory {
            ...
            sensitivity: if ma.sensitivity == crate::memory::types::Sensitivity::Secret
                || mb.sensitivity == crate::memory::types::Sensitivity::Secret
            {
                crate::memory::types::Sensitivity::Secret
            } else {
            ...
            estimated_tokens: crate::memory::governance::estimate_tokens(&content),
    ...
    pub fn split(&self, id: Uuid, parts: &[String]) -> MemoryResult<Vec<Uuid>> {
        ...
        for part in parts {
            let child = Memory {
                ...
                estimated_tokens: crate::memory::governance::estimate_tokens(part),
                created_at: now,
                valid_from: now,
                state: MemoryState::Active,
