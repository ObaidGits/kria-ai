...
//! transaction (F1.3 invariant). It owns no [`Database`](crate::memory::db::Database)
//! / connection / pool.
//!
...
use crate::memory::model::RelationshipId;
...
/// [`crate::memory::model::entity::Mention`]).
...
/// [`Database`](crate::memory::db::Database) / connection / pool.
...
mod tests {
    ...
    use crate::memory::model::{PolicyPartition, Version};
    use std::sync::Arc;
