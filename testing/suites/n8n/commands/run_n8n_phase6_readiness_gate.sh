...
check_selection_eval_set_exists() {
    local eval_script="$ROOT_DIR/testing/suites/n8n/commands/run_n8n_evals.sh"
    local phase5_script="$ROOT_DIR/testing/suites/n8n/commands/run_n8n_phase5_invocation.sh"
