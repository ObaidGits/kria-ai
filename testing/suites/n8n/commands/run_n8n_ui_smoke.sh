...
check_smoke_test_exists() {
    ...
    test -f "$ROOT_DIR/testing/suites/playwright/tests/n8n-workflow-hub.tauri-mock.e2e.spec.ts"
    rg -q "n8n workflow hub Tauri smoke" "$ROOT_DIR/testing/suites/playwright/tests/n8n-workflow-hub.tauri-mock.e2e.spec.ts"
}
...
run_playwright_smoke() {
    cd "$ROOT_DIR/testing/suites/playwright" &&
