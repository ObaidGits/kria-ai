...
## Low-Token Workflow
- First read `PROJECT_CONTEXT.md`, `CORE_CONTEXT.md`, and this guide.
- For structure questions, read `CODEBASE_MAP.md` and `FILE_INDEX.md`.
- For implementation work, inspect source files named in the relevant feature section before editing.
- For remote/fleet work, read the RFCs before changing code.
