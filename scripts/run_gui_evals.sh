...
#
# Usage:
#   ./scripts/run_gui_evals.sh              # Run all evals (42 scenarios)
#   ./scripts/run_gui_evals.sh browser      # Run only browser evals (6)
#   ./scripts/run_gui_evals.sh ide          # Run only IDE/code evals (5)
#   ./scripts/run_gui_evals.sh file         # Run only file/filesystem evals (5)
#   ./scripts/run_gui_evals.sh system       # Run only system/desktop evals (5)
#   ./scripts/run_gui_evals.sh interactive  # Run only interactive GUI evals (4)
#   ./scripts/run_gui_evals.sh recovery     # Run only error recovery evals (5)
#   ./scripts/run_gui_evals.sh multi        # Run only multi-app evals (4)
#   ./scripts/run_gui_evals.sh long         # Run only long-horizon evals (4)
#   ./scripts/run_gui_evals.sh quick        # Run browser + ide + file (16)
...
EVAL_DIR="$HOME/.kria/eval_reports"
