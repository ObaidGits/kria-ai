...
- Historical docs should be treated as background only unless explicitly requested.
- This folder is AI-facing orientation, not execution authority; verify against source before invasive implementation decisions.
